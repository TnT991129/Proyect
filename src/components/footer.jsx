      ...
      <div className="mx-auto px-6 lg:px-8 py-16 sm:py-24 lg:py-32 max-w-7xl">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="flex justify-center mt-8">
            <a
              href="#"
              className="bg-primary hover:bg-primary shadow-sm px-3.5 py-2.5 rounded-md font-semibold text-sm text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
            >
              Get started
            </a>
          </div>
